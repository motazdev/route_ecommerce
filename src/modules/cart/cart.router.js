...
import { addToCart, clearCart, updateCart, userCart } from "./cart.controller.js";
const router = Router();
...
router.patch("/:productId", isAuthenticated, isValid(removeProductFromCartSchema), asyncHandler());
